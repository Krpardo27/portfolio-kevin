...
const About = () => {
  return (
    <section
      id="inicio"
      className="mt-1 relative flex flex-col bg-[#1a1a1a] lg:p-12 p-2 rounded-xl lg:overflow-y-auto scrollbar-custom overflow-hidden"
    >
      <div className="absolute w-16 h-16 border-t-[3px] border-l-[3px] border-dashed border-[#a5fa98] lg:top-0 lg:left-0 top-2 left-2"></div>
      <div className="flex items-center justify-center w-full flex-col ">
        ...
        <div className="w-full lg:mt-10 h-full">
          ...
          <div className="flex lg:flex-row flex-col gap-12 space-y-5 items-center mt-2">
            <img src={PC} alt="" className="lg:w-[220px] lg:h-[220px] w-[120px] h-[120px] hidden lg:block" />
