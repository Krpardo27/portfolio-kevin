          ...
          <div className="flex flex-col w-full gap-10 items-center relative px-5 pb-20">
            {educaction.map((edu, index) => (
              ...
              >
                  ...
                  <div className="relative">
                    <div className="lg:relative absolute lg:w-full lg:h-full w-[45px] h-[45px] transform -translate-x-1/2 translate-y-0 z-0 -top-3 left-3">
                      <img
                        ...
                        alt={edu.company}
                        className="lg:w-[100px] lg:h-[100px] h-full rounded-full object-contain lg:border-[5px] border-[2px] border-[#252525] bg-white"
                      />
                      {/* Línea vertical (solo si no es el último item) */}
                      {index !== educaction.length - 1 && (
                        <div className="hidden lg:flex absolute left-[32px] lg:top-21 lg:left-1/2 lg:w-1 w-[1px] bg-[#252525] lg:h-[250px] transform -translate-x-1/2 translate-y-0 z-0"></div>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="lg:w-5/6 w-full lg:px-[50px] lg:py-[30px] px-5 py-5 bg-[#212121] rounded-xl ">
                  <div className="flex lg:flex-row flex-col w-full justify-between lg:items-center space-y-2">
                    <h3 className="text-[#e1e8f0] lg:text-xl">
                      {edu.title}
                    </h3>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <h3 className="text-[#e1e8f0]">{edu.institution}</h3>
                  </div>
                </div>
              </div>
            ))}
