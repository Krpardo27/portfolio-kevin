    ...
    <PageWrapper>
      ...
      >
        ...
        <div className="lg:mt-20 mt-10">
          <div className="flex flex-col w-full gap-10 items-center relative px-5 pb-20 shadow-xl">
            {experience.map((exp, index) => (
              ...
              >
                  ...
                  <div className="relative">
                    <div className="lg:relative absolute lg:w-full lg:h-full w-[45px] h-[45px] transform -translate-x-1/2 translate-y-0 z-0 -top-3 left-3">
                      ...
                      {index !== experience.length - 1 && (
                        <div className="hidden lg:flex absolute left-[32px] lg:top-21 lg:left-1/2 lg:w-[2px] w-[1px] bg-[#252525] lg:h-[650px] transform -translate-x-1/2 translate-y-0 z-0"></div>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="lg:w-5/6 lg:px-8 px-5 py-5 dark:bg-[#212121] bg-[#FBFBFB] rounded-xl ">
                  <div className="flex justify-between items-center space-y-5">
                    <h3 className="text-grisOscuro dark:text-[#6a7178] text-xl">{exp.office}</h3>
                    <span className="bg-[#181818] text-[#e1e8f0] lg:px-5 lg:py-3 rounded-md py-2 px-2 w-max text-[14px]">
                      {exp.date}
                    </span>
                  </div>
                  <div className="flex items-center justify-between mt-2">
                    <h3 className="text-grisOscuro dark:text-[#6a7178]">{exp.company}</h3>
                  </div>
                  <div className="flex flex-col gap-6 mt-4">
                    <h4 className="text-grisOscuro dark:text-[#6a7178] lg:text-[18px] text-[14px]">
                      {exp.description}
                    </h4>
